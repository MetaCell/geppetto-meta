 ...
 */
(function (e){
  typeof exports == "object" ? module.exports = e(require("backbone"),require("underscore")) : typeof define == "function" && define.amd && define(["backbone","underscore"],e)
})(function (e,t){
  return e.Validation = function (e){
    "use strict";var t = { forceUpdate:!1,selector:"name",labelFormatter:"sentenceCase",valid:Function.prototype,invalid:Function.prototype },n = {
        formatLabel:function (e,n){
          return a[t.labelFormatter](e,n)
        },format:function (){
          var e = Array.prototype.slice.call(arguments),t = e.shift();return t.replace(/\{(\d+)\}/g,function (t,n){
        ...
        var i = function (t){
            ...
            var r = t.validation ? t.validation[n] || {} : {};if (e.isFunction(r) || e.isString(r)){
              r = { fn:r };
            ...
            return e.reduce(o(t,r),function (o,u){
              var a = e.extend({},n,f),l = u.fn.call(a,i,r,u.val,t,s);return l === !1 || o === !1 ? !1 : l && !o ? u.msg || l : o
            },"")
          },a = function (t,n){
            var i,s = {},o = !0,a = e.clone(n),f = r(n);return e.each(f,function (e,n){
            ...
            return {
              preValidate:function (t,n){
                ...
                var n = r(this.attributes);return e.isString(t) ? !u(this,t,n[t],e.extend({},this.attributes)) : e.isArray(t) ? e.reduce(t,function (t,r){
                ...
                var u = this,f = !s,l = e.extend({},n,o),c = i(u),h = e.extend({},c,u.attributes,s),p = r(s || h),d = a(u,h);u._isValid = d.isValid,e.each(c,function (e,n){
                  var r = d.invalidAttrs.hasOwnProperty(n);r || l.valid(t,n,l.selector)
                }),e.each(c,function (e,n){
                  var r = d.invalidAttrs.hasOwnProperty(n),i = p.hasOwnProperty(n);r && (i || f) && l.invalid(t,n,d.invalidAttrs[n],l.selector)
                }),e.defer(function (){
                  u.trigger("validated",u._isValid,u,d.invalidAttrs),u.trigger("validated:" + (u._isValid ? "valid" : "invalid"),u,d.invalidAttrs)
                });if (!l.forceUpdate && e.intersection(e.keys(d.invalidAttrs),e.keys(p)).length > 0) {
          ...
          version:"0.7.1",configure:function (n){
            e.extend(t,n)
          },bind:function (n,r){
            var i = n.model,o = n.collection;r = e.extend({},t,s,r);if (typeof i == "undefined" && typeof o == "undefined") {
              throw "Before you execute the binding your view must have a model or a collection.\nSee http://thedersen.com/projects/backbone-validation/#using-form-model-validation for more information.";
            }i ? c(n,i,r) : o && (o.each(function (e){
              c(n,e,r)
            }),o.bind("add",p,{ view:n,options:r }),o.bind("remove",d))
          },unbind:function (e){
            var t = e.model,n = e.collection;t && h(e.model),n && (n.each(function (e){
              h(e)
        ...
        var t = String.prototype.trim ? function (e){
            ...
            var t = /^\s+/,n = /\s+$/;return e === null ? "" : e.toString().replace(t,"").replace(n,"")
          },n = function (t){
          ...
          fn:function (t,n,r,i,s){
            ...
            var a = e.isFunction(i) ? i.call(s,t,n,o) : i;if (!a && !r(t)) {
              return !1;
            } if (a && !r(t)) {
              return this.format(u.required,this.formatLabel(n,s))
            }
          },acceptance:function (t,n,r,i){
            if (t !== "true" && (!e.isBoolean(t) || t === !1)) {
              return this.format(u.acceptance,this.formatLabel(n,i))
            }
          },min:function (e,t,r,i){
            if (!n(e) || e < r) {
              return this.format(u.min,this.formatLabel(t,i),r)
            }
          },max:function (e,t,r,i){
            if (!n(e) || e > r) {
              return this.format(u.max,this.formatLabel(t,i),r)
            }
          },range:function (e,t,r,i){
            if (!n(e) || e < r[0] || e > r[1]) {
              return this.format(u.range,this.formatLabel(t,i),r[0],r[1])
            }
          },length:function (e,n,i,s){
            if (!r(e) || t(e).length !== i) {
              return this.format(u.length,this.formatLabel(n,s),i)
            }
          },minLength:function (e,n,i,s){
            if (!r(e) || t(e).length < i) {
              return this.format(u.minLength,this.formatLabel(n,s),i)
            }
          },maxLength:function (e,n,i,s){
            if (!r(e) || t(e).length > i) {
              return this.format(u.maxLength,this.formatLabel(n,s),i)
            }
          },rangeLength:function (e,n,i,s){
            if (!r(e) || t(e).length < i[0] || t(e).length > i[1]) {
              return this.format(u.rangeLength,this.formatLabel(n,s),i[0],i[1])
            }
          },oneOf:function (t,n,r,i){
            if (!e.include(r,t)) {
              return this.format(u.oneOf,this.formatLabel(n,i),r.join(", "))
            }
          },equalTo:function (e,t,n,r,i){
            if (e !== i[n]) {
              return this.format(u.equalTo,this.formatLabel(t,r),this.formatLabel(n,r))
            }
          },pattern:function (e,t,n,i){
            if (!r(e) || !e.toString().match(o[n] || n)) {
              return this.format(u.pattern,this.formatLabel(t,i),n)
            }
          } 
        }
      }();return i
