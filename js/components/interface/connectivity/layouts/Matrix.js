...
export class Matrix {
  ...
  draw () {
    ...
    const matrix = [];
    const nodes = this.connectivity.dataset.nodes;
    var root = this.connectivity.dataset.root;
    var n = nodes.length;
    ...
    var colormap = this.connectivity.nodeColormap.range ? this.connectivity.nodeColormap : d3.scaleOrdinal(d3.schemeCategory20);
    ...
    }).appendTo(this.connectivity.connectivityContainer);
