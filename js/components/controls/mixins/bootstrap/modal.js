...
define(function (require) {
  ...
  return function () {
    ...
    var bsModalEvents = { handleShow: 'show.bs.modal', handleShown: 'shown.bs.modal', handleHide: 'hide.bs.modal', handleHidden: 'hidden.bs.modal' };
    ...
    return {
      ...
      componentDidMount: function () {
        var $modal = $(ReactDOM.findDOMNode(this)).modal({ backdrop: this.props.backdrop, keyboard: this.props.keyboard, show: this.props.show, remote: this.props.remote });
