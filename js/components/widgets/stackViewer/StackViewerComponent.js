    ...
    componentWillReceiveProps: function (nextProps) {
      ...
      if (nextProps.scl !== this.state.scl || nextProps.zoomLevel !== this.props.zoomLevel || nextProps.width !== this.props.width || nextProps.height !== this.props.height){
        if (nextProps.scl !== this.state.scl) {
          this.stack.position.x += this.state.imageX * ((Number(this.state.scl * this.disp.scale.x) - Number(nextProps.zoomLevel) / 20.0));
          this.stack.position.y += this.state.imageY * ((Number(this.state.scl * this.disp.scale.y) - Number(nextProps.zoomLevel) / 20.0));
        }
