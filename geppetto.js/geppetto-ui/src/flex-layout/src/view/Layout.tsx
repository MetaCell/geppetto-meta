...
export interface ILayoutCallbacks {
    ...
    customizeBottomBar(tabNode?: TabNode): void;
...
export class Layout extends React.Component<ILayoutProps, ILayoutState> {
    ...
    render() {
        ...
        return (
            <div
                style={layoutStyle}
                ref={this.selfRef}
                className={this.getClassName(CLASSES.FLEXLAYOUT__LAYOUT)} onDragEnter={this.props.onExternalDrag ? this.onDragEnter : undefined}
            >
                {tabSetComponents}
                {this.tabIds.map((t) => {
    ...
    customizeBottomBar(tabNode: TabNode) {
        if (this.props.clickOnBordersAction) {
            ...
            this.doAction(Actions.selectTab(tabNode.getId()));
        }
    }
}
