define(function (require) {
  ...
  var EventManager = require('@metacell/geppetto-meta-core/common/EventManager').default
  ...
  var Spotlight = CreateClass({
    ...
    initTypeahead: function () {
      ...
      },
      {
        ...
        limit: 5,
        display: 'label',
        templates: { suggestion: Handlebars.compile('<div class="spotlight-suggestion">{{geticon icon}} {{label}}</div>') }
      },
      {
        name: 'instances',
        ...
        limit: 50,
        display: 'path',
        templates: { suggestion: Handlebars.compile('<div>{{geticonFromMetaType metaType}} {{path}}</div>') }
      },
      {
