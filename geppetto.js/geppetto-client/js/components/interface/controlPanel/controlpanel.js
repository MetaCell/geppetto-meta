define(function (require) {
    ...
    computeResult: function (controlId) {
      ...
      case 'activeExperimentFilterBtn':
        if (!this.state.activeExperimentFilterToggled) {
           ...
           */
          var recordedVisibility = !!this.state.stateVarsFilterToggled;
  ...
  var ControlPanel = CreateClass({
    ...
    UNSAFE_componentWillReceiveProps: function (nextProps) {
      ...
      if (nextProps.projectStatus !== this.props.projectStatus && nextProps.projectStatus === EventManager.clientActions.PROJECT_LOADED) {
        this.clearData();
      }
