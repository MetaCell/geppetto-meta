...
class WidgetFactory {
  ...
  private WidgetToComponent = ({ widgetConfig }: { widgetConfig: Widget }) => {
    ...
    const proto = Component.WrappedComponent
      ? Component.WrappedComponent.proto
      : Component.proto;
    const ref =
      proto && proto.importSession ? { ref: this.refs[widgetConfig.id] } : {};
    ...
    return Component ? (
      ...
      <div>
        Error on widget configuration {widgetConfig.id}: no component matching "
