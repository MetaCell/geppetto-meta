...
class LayoutManager {
  ...
  onRenderTabSet = (panel, renderValues, tabSetButtons) => {
    console.log(tabSetButtons, panel, 'Tabset');
   ...
   * @param renderValues
   */
  onRenderTab = (panel, renderValues) => {
      ...
      <div className={classes.flexlayout}>
        <FlexLayout.Layout
          ...
          onRenderTab={(node, renderValues) =>
            layoutManager.onRenderTab(node, renderValues)
          }
   ...
   * @memberof Control
   */
  getComponent = (config?: IComponentConfig) =>
    withStyles(styles)(this.Component(this, config));
  ...
  onAction(action) {
    ...
    switch (action.type) {
      ...
      case Actions.SELECT_TAB:
        this.store.dispatch(
          updateWidget({
            ...this.getWidget(action.data.tabNode),
      ...
      case Actions.RENAME_TAB:
        this.store.dispatch(
          updateWidget({
            ...this.getWidget(action.data.node),
