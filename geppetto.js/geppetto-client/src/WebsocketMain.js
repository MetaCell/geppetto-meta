...
import GlobalHandler from './communication/GlobalHandler';
...
export function init () {
  ...
  MessageSocket.addHandler(new GlobalHandler(MessageSocket));
  MessageSocket.addHandler(MessageHandler(MessageSocket));
