...
import neuron from '/assets/SketchVolumeViewer_SAAVR_SAAVR_1_1_0000_draco.gltf?url';
import contact from '/assets/Sketch_Volume_Viewer_AIB_Rby_AIAR_AIB_Rby_AIAR_1_1_0000_green_0_24947b6670.gltf?url';
...
const SimpleInstancesExample: React.FC = () => {
    ...
    return showLoader ? (
      ...
      <Box ref={layoutRef} className={classes.container}>
          <Canvas
            data={canvasData}
