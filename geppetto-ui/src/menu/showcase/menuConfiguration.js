          ...
          list: [
            ...
            },
            {
              ...
              action: {
                handlerAction: 'openNewTab',
                parameters: [
                  'https://www.facebook.com/pages/Virtual-Fly-Brain/131151036987118',
                ],
              },
            },
            {
          ...
          list: [
            ...
            },
            {
              ...
              action: {
                handlerAction: 'openNewTab',
                parameters: [
                  'http://nblast.virtualflybrain.org:8080/NBLAST_on-the-fly/?gal4_n=10&all_use_mean=F&all_query=&tab=One%20against%20all&gal4_query=',
                ],
              },
            },
          ],
              ...
              list: [
                {
                  ...
                  action: {
                    handlerAction: 'openNewTab',
                    parameters: [
                      'https://fafb.catmaid.virtualflybrain.org/?pid=1&zp=65720&yp=160350.0517811483&xp=487737.6942783438&tool=tracingtool&sid0=1&s0=3.1999999999999993&help=true',
                    ],
                  },
                },
                {
                  ...
                  action: {
                    handlerAction: 'openNewTab',
                    parameters: [
                      'https://vnc1.catmaid.virtualflybrain.org/?pid=1&zp=55260&yp=512482.5999999994&xp=173092.19999999998&tool=tracingtool&sid0=1&s0=9&help=true',
                    ],
                  },
                },
                {
                  ...
                  action: {
                    handlerAction: 'openNewTab',
                    parameters: [
                      'https://l1em.catmaid.virtualflybrain.org/?pid=1&zp=108250&yp=82961.59999999999&xp=54210.799999999996&tool=tracingtool&sid0=1&s0=2.4999999999999996&help=true',
                    ],
                  },
                },
              ],
              ...
              list: [
                {
                  ...
                  action: {
                    handlerAction: 'openNewTab',
                    parameters: [
                      'https://fafb.catmaid.virtualflybrain.org/apis/',
                    ],
                  },
                },
                {
                  ...
                  action: {
                    handlerAction: 'openNewTab',
                    parameters: [
                      'https://vnc1.catmaid.virtualflybrain.org/apis/',
                    ],
                  },
                },
                {
                  ...
                  action: {
                    handlerAction: 'openNewTab',
                    parameters: [
                      'https://l1em.catmaid.virtualflybrain.org/apis/',
                    ],
                  },
                },
              ],
          ...
          list: [
            {
              ...
              action: {
                handlerAction: 'triggerRunQuery',
                parameters: [
                  'alignedDatasets,VFB_00101567,adult brain unisex JFRC2018',
                ],
              },
            },
            {
              ...
              action: {
                handlerAction: 'triggerRunQuery',
                parameters: [
                  'alignedDatasets,VFB_00017894,adult brain template JFRC2',
                ],
              },
            },
            {
            ...
            },
            {
              ...
              action: {
                handlerAction: 'triggerRunQuery',
                parameters: [
                  'alignedDatasets,VFB_00101384,Janelia FlyEM HemiBrain',
                ],
              },
            },
            {
      ...
      list: [
        {
          ...
          action: {
            handlerAction: 'openNewTab',
            parameters: [
              'https://groups.google.com/forum/embed/?place=forum/vfb-suport#!forum/vfb-suport',
            ],
          },
        },
        {
