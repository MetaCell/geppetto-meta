...
class DicomViewer extends Component {
    ...
    configureEvents() {
        ...
        function goToPoint(event) {
            ...
            const mouse = {
                ...
                y: -((event.clientY - offset(canvas).top) / canvas.clientHeight) * 2 + 1,
            };
            ...
            if (intersects.length > 0) {
                let ijk = StackModel.worldToData(stackHelper.stack, intersects[0].point);
    ...
    restore() {
        this.setState({fullScreen: false, size: this.props.size})
    }

    fullScreen() {
        this.setState({fullScreen: true, size: {height: window.innerHeight, width: window.innerWidth}})
    }
        ...
        return (
            <div ref={this.container} key={this.props.id + "_component"} id={this.props.id + "_component"}
                ...
                <div className={classes.dicomViewer} style={{height: "800px", width: "100%"}}>
                    ...
                    <div id="r1" className={classes.renderer + " r1"} style={{
                    ...
                    <div id="r2" className={classes.renderer + " r2"} style={{
                    ...
                    <div id="r3" className={classes.renderer + " r3"} style={{
