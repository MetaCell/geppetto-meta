...
THREE.OBJLoader.prototype = {
  ...
  createMesh: function (vertices, color) {
    ...
    var material = new THREE.PointsMaterial(
      {
        size: 2,
        map: textureLoader.load("geppetto/node_modules/@geppettoengine/geppetto-client/geppetto-client//js/components/interface/3dCanvas/particle.png"),
  ...
  parse: function (text) {
    ...
    if (hasFaces) {
      ...
      container.add(this.createMesh(state.vertices, ('0x' + Math.floor(Math.random() * 16777215).toString(16))));
    }
