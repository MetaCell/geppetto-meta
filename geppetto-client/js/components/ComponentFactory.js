      ...
      _createComponent: function (componentType, properties, container, callback, isWidget) {
        ...
        return new Promise(resolve => {
          require.ensure([],function (require){
            ...
            case 'PYTHONCONSOLE': require(['./../../../geppetto-ui/src/components/python-console/PythonConsole'],cb); break;
            case 'DICOMVIEWER': require(['./../../../geppetto-ui/src/components/dicom-viewer/DicomViewer'],cb); break;
            ...
            case 'MOVIEPLAYER': require(['./../../../geppetto-ui/src/components/movie-player/MoviePlayer'],cb); break;
            case 'TREE': require(['./../../../geppetto-ui/src/components/tree-viewer/Tree'],cb); break;
