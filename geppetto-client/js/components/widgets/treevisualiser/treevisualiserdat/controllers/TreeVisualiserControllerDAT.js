  ...
  return AWidgetController.View.extend({
    ...
    addWidget: function (isStateless) {
      ...
      return new Promise(resolve => {
        require.ensure([], function (require) {
          ...
          GEPPETTO.CommandController.updateHelpCommand(tvdat, id, that.getFileComments("geppetto/node_modules/@geppettoengine/geppetto-client/geppetto-client/js/components/widgets/treevisualiser/treevisualiserdat/TreeVisualiserDAT.js"));
    ...
    getCommands: function (node) {
      ...
      if (node.getWrappedObj().capabilities != null && node.getWrappedObj().capabilities.length > 0 && node.getWrappedObj().capabilities.indexOf('VisualGroupCapability') != -1){
        var visualGroup = [{ label: "Show Visual Groups" }];
