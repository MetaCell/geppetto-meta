...
require.config({
  ...
  shim: {
    ...
    jqueryUICore : { deps: ['jquery','jqueryUI'] },
    jqueryUIPosition : { deps: ['jquery','jqueryUI'] },
    jqueryUIWidget : { deps: ['jquery','jqueryUI'] },
    jqueryUISelectMenu : { deps: ['jquery','jqueryUI', 'jqueryUICore', 'jqueryUIPosition','jqueryUIWidget'] },
    deparam : { deps: ['jquery'] }
  }
